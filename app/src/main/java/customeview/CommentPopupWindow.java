...
public class CommentPopupWindow extends PopupWindow implements View.OnClickListener, AtUserNickAdapter.AtNickCallBack
    ...
    public CommentPopupWindow(Context context, List<HomeVideoImg.DataBean.IndexListBean> homevideodatas, int curposition) {
        super(context);
                                            ...
                                            ((Activity) context).runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    if (comentdatas != null) {
                                                        ...
                                                        commentAdapter.setOnAuthorityReplayLinstener(CommentPopupWindow.this);
                        ...
                        if (attentionPersonVideo.getData() != null && attentionPersonVideo.getData().getPageList() != null) {
                            ((Activity) context).runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    atUsernickAdatpter.setOnNickItemLinstener(CommentPopupWindow.this);
