...
public class PreferencesUtil {
     ...
     */
    public static final String SHARED_PREFERENCES_NAME = "short_video";
    public static final String SP_PATH_SERVER = "sp_path_server";
    public static final String SP_USER_INFO = "sp_user_info";
    public static final String SP_SHOPPING_CART = "sp_shopping_cart";
