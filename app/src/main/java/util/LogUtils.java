...
//    }
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MyApplication.mContext
                    .getPackageManager()
    ...
    public static class Config {
        ...
        private boolean release = !MyApplication.isDebug;

        private Config() {
            if (mDefaultDir != null) return;
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.mContext.getExternalCacheDir() != null)
                mDefaultDir = MyApplication.mContext.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = MyApplication.mContext.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
