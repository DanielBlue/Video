...
public class VideoCropActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoCropViewBar = (VideoCropViewBar) findViewById(R.id.tidal_pat_video_crop_crop_view);
        mSpeedLevelControllerView = (NewSpeedLevelControllerView) findViewById(R.id.tidal_pat_video_crop_speed_controller_view);
        mSaveImg = (ImageView) findViewById(R.id.tidal_pat_crop_video_save_img);
        mSelectedTxt = (TextView) findViewById(R.id.tidal_pat_video_crop_selected_time_txt);
