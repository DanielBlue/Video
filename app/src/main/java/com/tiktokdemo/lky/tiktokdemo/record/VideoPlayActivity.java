...
//        getWindow().setAttributes(params);
    ...
    private void initView() {
        ...
        mVideoPlayView = (SpecialEffectsPlayView) findViewById(R.id.tidal_pat_record_video_upload_pv);
        ...
        mVideoCoverImg = (ImageView) findViewById(R.id.tidal_pat_upload_video_cover_select_img);
...
//                showCutAudioLayout();
    ...
    private void initSpecialEffectsView(){
        ...
        mSpecialEffectsSeekBar = (SpecialEffectsSeekBar) findViewById(R.id.tidal_pat_upload_se_seek_bar);
        ...
        mSEFilterTxt = (TextView) findViewById(R.id.tidal_pat_upload_se_bottom_filter_txt);
        mSETimeTxt = (TextView) findViewById(R.id.tidal_pat_upload_se_bottom_time_txt);
