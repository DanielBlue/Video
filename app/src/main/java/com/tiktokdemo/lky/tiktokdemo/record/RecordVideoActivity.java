...
//        mPresenter.checkBGMPathUpdata();
    ...
    public void initView() {
        ...
        mBreakProgressView = (BreakProgressView) findViewById(R.id.tidal_pat_record_video_break_progress);
...
//        mRecordTimeCount = mTidalPatRecordDraftBean.getRecordContinueTime();
        ...
        mFlashImg = (ImageView) findViewById(R.id.tidal_pat_record_video_flash_img);
        mFlipImg = (ImageView) findViewById(R.id.tidal_pat_record_video_flip_img);
        mSaveImg = (ImageView) findViewById(R.id.tidal_pat_record_video_save_img);

        mCutMusicImg = (ImageView) findViewById(R.id.tidal_pat_record_video_cut_music_img);
        mCountDownImg = (ImageView) findViewById(R.id.tidal_pat_record_video_count_down_img);
        mCountDownTxt = (CountDownTextView) findViewById(R.id.tidal_pat_record_video_count_down_txt);

        mSpeedLevelControllerView = (NewSpeedLevelControllerView) findViewById(R.id.tidal_pat_record_speed_controller_view);
        mSpeedLevelControllerView.setOnSpeedLevelChangeListener(mSpeedLevelChangeListener);
        mCircleRecordView = (CircleRecordView) findViewById(R.id.tidal_pat_record_start_img);
        ...
        mFilterRecyclerView = (RecyclerView) findViewById(R.id.tidal_pat_record_filter_recycler);
        ...
        mCutAudioScaleRoundRectView = (ScaleRoundRectView) findViewById(R.id.tidal_pat_record_cut_audio_scale_view);
        mCutAudioScaleRoundRectView.setMax(50);//假数据
        mCutAudioScaleRoundRectView.setOnDragListener(mOnDragListener);
        mCutAudioCurrentTxt = (TextView) findViewById(R.id.tidal_pat_record_cut_audio_current_time_txt);
        mCutAudioMaxTxt = (TextView) findViewById(R.id.tidal_pat_record_cut_audio_max_time_txt);
...
//            });
    ...
    private CircleRecordView.OnRecordChangeListener mOnRecordChangeListener = new CircleRecordView.OnRecordChangeListener() {
        ...
        public void onEventDown() {//按下录制
            ...
            if (isSelectMusic && !isDown) {
                mPresenter.setMediaSource(Constant.DOWNBGM + File.separator + playName + ".mp3");
            }
        }
...
//                startActivityForResult(intent, 1);
    ...
    public void showLoadingView(boolean isShow, int loadingTxtRes) {
        ...
        ImageView imgProgress = (ImageView) mLoadingView.findViewById(R.id.personal_show_loading_img);
        Animation set = AnimationUtils.loadAnimation(this, R.anim.anim_center_rotate);
        set.setInterpolator(new LinearInterpolator());
...
//        mTidalPatRecordDraftBean.setMusicLocalUrl(mMusicBean.getUrl());
        ...
        if (isSelectMusic) {
            intent.putExtra("AudioId", curAudio);
            intent.putExtra("Name", playName);
        }
...
//                        mPresenter.combineVideo(0,7,path);//
//                    }
//
//                    @Override
